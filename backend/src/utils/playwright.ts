...
import { pxToInt } from './playwright/base';
  ...
  for (const div of divs) {
    if (await div.isVisible()) {
      ...
      let data = {
        ...
        bg: bg.hex,
        alpha: bg.alpha,
        borderTopLeftRadius: pxToInt(computed.borderTopLeftRadius),
        borderTopRightRadius: pxToInt(computed.borderTopRightRadius),
        borderBottomLeftRadius: pxToInt(computed.borderBottomLeftRadius),
        borderBottomRightRadius: pxToInt(computed.borderBottomRightRadius),
...
// http://localhost:5000/api/v1/scrape/imgs
